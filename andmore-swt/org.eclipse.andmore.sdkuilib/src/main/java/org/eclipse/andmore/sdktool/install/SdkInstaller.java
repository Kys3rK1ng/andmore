...
public class SdkInstaller {
    ...
    protected static final String PREFS_SDK_DIR = "org.eclipse.andmore.sdk";
    ...
    File sdkLocation;
	/** Main Android preferences in workspace */
	private final IPreferenceStore adtPrefs;
     ...
     */
	public SdkInstaller(IPreferenceStore adtPrefs, ILogger consoleLogger) {
		this.adtPrefs = adtPrefs;
	...
	public String getWorkSpaceSdk() {
		return adtPrefs.getString(PREFS_SDK_DIR);
	}
	...
	public void updateSdkLocation(File sdkLocation) throws IOException {
        adtPrefs.setValue(PREFS_SDK_DIR, sdkLocation.toString());
        if (adtPrefs instanceof IPersistentPreferenceStore) {
        	IPersistentPreferenceStore preferenceStore = (IPersistentPreferenceStore)adtPrefs;
